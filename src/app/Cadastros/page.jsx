    ...
    return (
        ...
        <div>
            ...
            <div className="flex justify-center flex-wrap gap-6 p-12">
                ...
                <a href="/Cadastro_PF" className="border-2 border-black rounded-xl px-10 py-4 w-72 text-center text-black no-underline transition-all duration-300 hover:bg-blue-600 hover:text-white">Cadastro de Pessoa Física</a>
                <a href="/Cadastro_PJ" className="border-2 border-black rounded-xl px-10 py-4 w-72 text-center text-black no-underline transition-all duration-300 hover:bg-blue-600 hover:text-white">Cadastro de Pessoa Juridica</a>
