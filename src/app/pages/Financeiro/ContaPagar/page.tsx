    ...
    <div className="flex flex-row font-nunito">
      <div className="w-3/4 p-6">
        ...
        <InstructionStep
          ...
          src="/img/Financeiro/ContaPagar.png"
          alt="Conta a Pagar"
          width={270}
          height={270}
          openModal={openModal}
        ...
        <InstructionStep
          ...
          src="/img/Financeiro/ListagemContaPagar.png"
        ...
        <InstructionStep
          ...
          src="/img/Financeiro/SalvarConta.png"
        ...
        <InstructionStep
          ...
          src="/img/Financeiro/ListagemContaPagar2.png"
          alt="Listagem Conta a Pagar"
          width={500}
          height={350}
          openModal={openModal}
